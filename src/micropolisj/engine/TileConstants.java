...
public class TileConstants
{
	...
	static final char SOLARHOUSE = 964; //Tile id for the NEW_BUILDING tile. This is the id of the center of the tile as listed in tiles.rc
	static final char ROLLER = 973; 
