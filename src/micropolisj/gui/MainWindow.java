	...
	implements Micropolis.Listener, EarthquakeListener
{
	...
	public MainWindow(Micropolis engine)
	{
		...
		overlaysMenu.add(makeMapStateMenuItem("menu.overlays.HAPPINESS_OVERLAY", MapState.HAPPINESS_OVERLAY));
	...
	private JToolBar makeToolbar()
	{
		...
		gridBox.add(b7,c);
		b7.add(makeToolBtn(MicropolisTool.SOLARHOUSE));
		b7.add(makeToolBtn(MicropolisTool.ROLLER));
